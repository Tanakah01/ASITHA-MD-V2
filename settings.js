...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=u7IiBLyK#SlLNGDh7UnjAa0ygmdlLa_uMrRKD66VGiCUZO7WnTMI' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello , I am Thri_iz_Kidd!!*" : process.env.ALIVE_MSG,
